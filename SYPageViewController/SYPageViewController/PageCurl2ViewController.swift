...
class PageCurl2ViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        // 当UIPageViewController.OptionsKey.spineLocation值为mid时，需要两个viewControllers
        self.setViewControllers([controllerSource[0], controllerSource[1]], direction: .forward, animated: false) { (completed) in
        }
    }
...
extension PageCurl2ViewController: UIPageViewControllerDelegate {
...
extension PageCurl2ViewController: UIPageViewControllerDataSource {
